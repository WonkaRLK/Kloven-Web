      ...
      <CartProvider>
        <div className="min-h-screen flex flex-col bg-kloven-black text-kloven-white">
          ...
          <a
            ...
            className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-kloven-carbon border border-kloven-smoke rounded-full flex items-center justify-center shadow-lg hover:scale-110 hover:border-kloven-ash transition-all duration-200"
          >
