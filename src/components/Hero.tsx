                  ...
                  <div className="animate-[levitate_4s_ease-in-out_infinite]">
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background: "linear-gradient(145deg, #c9c3b5 0%, #e0dbd0 20%, #d6d0c3 50%, #e8e4d9 80%, #cdc7ba 100%)",
                          boxShadow: "0 6px 30px rgba(0,0,0,0.6), 0 2px 8px rgba(0,0,0,0.3), inset 0 0 10px rgba(0,0,0,0.08)",
                          clipPath: "polygon(2% 4%, 4% 1%, 6% 3.5%, 9% 0.5%, 12% 2%, 14% 0%, 16% 3%, 19% 1%, 22% 0%, 24% 2.5%, 27% 0.5%, 30% 3%, 33% 0%, 36% 1.5%, 39% 3.5%, 42% 0%, 45% 2%, 48% 0.5%, 51% 3%, 54% 1%, 57% 0%, 60% 2.5%, 63% 0.5%, 66% 3.5%, 69% 1%, 72% 0%, 75% 2%, 78% 0.5%, 81% 3%, 84% 0%, 87% 1.5%, 90% 3.5%, 93% 0.5%, 96% 2%, 98% 0%, 100% 3.5%, 99% 7%, 100% 11%, 98% 15%, 100% 19%, 97.5% 23%, 100% 27%, 98.5% 31%, 100% 36%, 98% 40%, 100% 44%, 97.5% 48%, 100% 52%, 98.5% 56%, 100% 61%, 98% 65%, 100% 69%, 97.5% 73%, 100% 77%, 98.5% 81%, 100% 86%, 98% 90%, 100% 94%, 98.5% 97%, 97% 100%, 94% 97.5%, 91% 100%, 88% 96.5%, 85% 100%, 82% 97%, 79% 100%, 76% 96.5%, 73% 100%, 70% 97.5%, 67% 100%, 64% 97%, 61% 100%, 58% 96.5%, 55% 100%, 52% 97.5%, 49% 100%, 46% 97%, 43% 100%, 40% 96.5%, 37% 100%, 34% 97%, 31% 100%, 28% 96.5%, 25% 100%, 22% 97.5%, 19% 100%, 16% 97%, 13% 100%, 10% 96.5%, 7% 100%, 4% 97.5%, 1% 100%, 0% 96%, 1.5% 93%, 0% 89%, 2% 85%, 0% 81%, 1.5% 77%, 0% 73%, 2.5% 69%, 0% 65%, 1.5% 61%, 0% 56%, 2% 52%, 0% 48%, 1.5% 44%, 0% 40%, 2.5% 36%, 0% 31%, 1.5% 27%, 0% 23%, 2% 19%, 0% 15%, 1.5% 11%, 0% 7%)",
                        }}
                      >
                        <div className="relative w-[50vw] h-[70vh] overflow-hidden">
                          <Image
